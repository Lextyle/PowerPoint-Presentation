...
thank_you_for_watching_aninmation = []
thank_you_for_watching_folder_content = listdir("thank you for watching animation")
for filename in thank_you_for_watching_folder_content:
	thank_you_for_watching_aninmation.append(pygame.transform.scale(pygame.image.load(fr"thank you for watching animation\{filename}"), (1980, 1080)))
animations = [
...
[PlayAnimation(1980 // 2, 1080 // 2, (0, 255, 255), thank_you_for_watching_aninmation, True)]
]
